...
public class OrderController {
    ...
    @ApiOperation("商品销量排行TOP10")
    public Result<List<ProductSalesRankVO>> getProductSalesRankTop10() {
        log.info("查询商品销量排行TOP10");
        List<ProductSalesRankVO> rankList = orderService.getProductSalesRankTop10();
