...
@Api(tags = "商品管理相关接口")
@RequireRole({"admin", "manager", "clerk"})
public class ProductController {
    ...
    @ApiOperation("商品入库")
    public Result<String> increaseStock(@Valid @RequestBody ProductStockDTO productStockDTO) {
        log.info("商品入库，商品ID：{}，数量：{}", productStockDTO.getProductId(), productStockDTO.getQuantity());
        productService.increaseStock(productStockDTO);
        return Result.success();
    }
    ...
    @ApiOperation("商品出库")
    public Result<String> decreaseStock(@Valid @RequestBody ProductStockDTO productStockDTO) {
        log.info("商品出库，商品ID：{}，数量：{}", productStockDTO.getProductId(), productStockDTO.getQuantity());
        productService.decreaseStock(productStockDTO);
        return Result.success();
    }
    ...
    @ApiOperation("设置商品库存")
    public Result<String> setStock(@PathVariable Long productId, @RequestParam Integer stock) {
        log.info("设置商品库存，商品ID：{}，库存：{}", productId, stock);
